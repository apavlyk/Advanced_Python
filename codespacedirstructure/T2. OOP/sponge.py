...
class Sponge():
    ...
    def set_color(self, color):
        print("Set sponge color {}".format(color))
        self.color = color
...
class SpongeFactory(Painter,Sponge):
    ...
    def set_color(self, color):
        ...
        for sponge in range(self.sponge_count):
            ...
            self.__class__.produced_count += 1
            self.sponges.append(super(Painter, self))


print(SpongeFactory.__mro__)
spf = SpongeFactory(10)
spf.set_color(2)
print(len(spf.sponges))
